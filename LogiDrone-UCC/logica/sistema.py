# logica/sistema.py — LogiDrone-UCC
# Sistema central: orquesta el mapa, los drones, los pedidos y el inventario.
# Único punto de contacto entre la GUI/API y la lógica.
...
# ── Modelos disponibles para agregar nuevos drones ────────────────────────────
...
class Sistema:
    def __init__(self):
        ...
        # Cola FIFO de pedidos pendientes
        self.cola_pedidos = Cola()

        # Inventario AVL de productos
        self.inventario = ArbolAVL()

        # Grilla de monitoreo 20×20
        ...
        # Próximo número de dron (D-05, D-06, …)
        self._contador_drones = 5
    ...
    def _inicializar_flota(self):
        ...
        # D-03: batería baja → mantenimiento automático
        self.drones['D-03'].bateria = 18
        self.drones['D-03']._evaluar_estado_bateria()

        # D-04: mantenimiento programado
    ...
    def agregar_dron(self, modelo, capacidad_kg=5.0, velocidad_kmh=80.0):
        """Crea un nuevo dron y lo agrega a la flota. Retorna (dron, mensaje)."""
    ...
    def despachar_siguiente(self):
        ...
        ruta, distancia = self.mapa.a_estrella(
            dron_libre.posicion_actual, pedido.destino_id, ZONAS_EXCLUIDAS)
    ...
    def mover_dron_matriz(self, id_dron, nueva_fila, nueva_col):
        ...
        resultado = self.espacio_aereo.mover_dron(
            dron.coord_fila, dron.coord_col, nueva_fila, nueva_col)
        if resultado:
