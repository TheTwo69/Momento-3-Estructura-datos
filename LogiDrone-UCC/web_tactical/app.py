...
# v5: Rutas evasivas ampliadas para máxima distancia de seguridad de zonas prohibidas
...
# ─────────────────────────────────────────────────────────────────────────────
# RUTAS VISUALES SEGURAS EXTREMAS (Waypoints ampliados para evitar intrusión)
# ─────────────────────────────────────────────────────────────────────────────
# Desvío masivo hacia el oeste para evitar la Base Militar de Taganga
WP_TAGANGA_OESTE = (11.2640, -74.2210, "WP_TAG_O")

# Desvíos masivos para rodear completamente el perímetro ensanchado de Ziruma
WP_ZIRUMA_ESTE   = (11.2320, -74.1910, "WP_Z_E")
WP_ZIRUMA_OESTE  = (11.2420, -74.2360, "WP_Z_O")
...
def _build_rutas_visuales():
    ...
    # Corredor Norte seguro: Evita zona Taganga pasando mucho más al oeste
    ...
    # Corredor Centro-Sur seguro: Rodea Ziruma por el flanco derecho (Este)
    rutas[("ALMACEN",   "RECARGA_S")] = [_wp("ALMACEN"), WP_ZIRUMA_OESTE, _wp("RECARGA_S")]
    rutas[("RECARGA_S", "ALMACEN")]   = [_wp("RECARGA_S"), WP_ZIRUMA_OESTE, _wp("ALMACEN")]

    # Corredor Litoral seguro: Rodea Ziruma por el flanco izquierdo (Oeste)
    rutas[("ALMACEN",   "BELLO")]     = [_wp("ALMACEN"), WP_ZIRUMA_OESTE, _wp("BELLO")]
    rutas[("BELLO",     "ALMACEN")]   = [_wp("BELLO"), WP_ZIRUMA_OESTE, _wp("ALMACEN")]
