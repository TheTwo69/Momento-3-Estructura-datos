...
# v3: agrega LOGISTICA_R (Punto Logístico Rodadero) al mapa y rutas visuales
...
#
# LOGISTICA_R: sus rutas (↔ RODADERO, ↔ RECARGA_S, ↔ BELLO) están todas
# en el sur-oeste, a más de 6 km de Ziruma → rutas directas sin waypoint.
...
def _build_rutas_visuales():
    ...
    Las rutas de LOGISTICA_R son todas directas (sur-oeste, lejos de Ziruma).
    """
    rutas = {}
    ...
    # ── Rutas directas existentes (ya están fuera del radio visual) ───────
    for par in [
    ...
    # ── Rutas de LOGISTICA_R (todas directas, sur-oeste, sin Ziruma) ──────
    for par in [
